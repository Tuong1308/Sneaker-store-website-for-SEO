        ...
        <div className="flex flex-col">
          ...
          {sizes.length > 0 && (
            <div className="mb-6">
              ...
              <div className={`flex flex-wrap gap-2 p-3 rounded-xl transition-all duration-300 ${
          ...
          <div className="flex gap-3 mb-8">
            ...
            <button
              ...
              className="flex-1 border-2 border-black py-4 rounded-xl font-bold hover:bg-black hover:text-white transition-all duration-300 active:scale-[0.98]"
            >
              Mua ngay
            </button>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="flex items-center gap-3 p-3 rounded-xl bg-emerald-50">
              ...
              <span className="text-sm font-medium text-emerald-700">Chính hãng 100%</span>
            </div>
            ...
            <div className="flex items-center gap-3 p-3 rounded-xl bg-blue-50">
              ...
              <span className="text-sm font-medium text-blue-700">Giao hàng toàn quốc</span>
            </div>
            ...
            <div className="flex items-center gap-3 p-3 rounded-xl bg-purple-50">
              ...
              <span className="text-sm font-medium text-purple-700">Đổi trả 30 ngày</span>
            </div>
            ...
            <div className="flex items-center gap-3 p-3 rounded-xl bg-amber-50">
              ...
              <span className="text-sm font-medium text-amber-700">Thanh toán COD</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="py-8">
          ...
          {activeTab === 'care' && (
            <div className="prose max-w-none">
              ...
              {!product.careGuide && !product.storageGuide && (
