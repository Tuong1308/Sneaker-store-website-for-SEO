      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                { name: 'Hướng dẫn mua hàng', href: '/pages/ho-tro-giai-dap-thac-mac#dat-hang' },
                { name: 'Chính sách đổi trả', href: '/pages/ho-tro-giai-dap-thac-mac#doi-tra-bao-hanh' },
                { name: 'Chính sách bảo hành', href: '/pages/ho-tro-giai-dap-thac-mac#doi-tra-bao-hanh' },
                { name: 'Hướng dẫn chọn size', href: '/pages/ho-tro-giai-dap-thac-mac#dat-hang' },
                { name: 'Câu hỏi thường gặp', href: '/pages/ho-tro-giai-dap-thac-mac' },
              ].map((item) => (
                <li key={item.name}>
                  <Link href={item.href} className="text-gray-400 hover:text-white transition-colors flex items-center gap-2 group text-sm">
                    <span className="w-1.5 h-1.5 rounded-full bg-red-500 opacity-0 group-hover:opacity-100 transition-opacity" />
