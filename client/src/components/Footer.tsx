        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <div className="flex gap-3 mt-6">
              ...
              <a href="#" className="w-10 h-10 rounded-full bg-white/10 hover:bg-gradient-to-br hover:from-purple-600 hover:to-pink-500 flex items-center justify-center transition-all">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="#" className="w-10 h-10 rounded-full bg-white/10 hover:bg-black flex items-center justify-center transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Thương hiệu */}
          <div>
            <h4 className="font-bold text-lg mb-5">Thương hiệu</h4>
          ...
          {/* Hỗ trợ */}
          <div>
            <h4 className="font-bold text-lg mb-5">Hỗ trợ</h4>
            <ul className="space-y-3">
              {[
                ...
                { name: 'Hướng dẫn chọn size', href: '/huong-dan-chon-size' },
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-400">123 Nguyễn Huệ, Q.1, TP.HCM</span>
              </li>
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-gray-400">contact@sneakerstore.vn</span>
              </li>
              <li className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-lg bg-white/10 flex items-center justify-center flex-shrink-0">
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6 text-sm">
              <Link href="/dieu-khoan" className="text-gray-500 hover:text-white transition">
                Điều khoản
              </Link>
              <Link href="/bao-mat" className="text-gray-500 hover:text-white transition">
                Bảo mật
              </Link>
            </div>
          </div>
